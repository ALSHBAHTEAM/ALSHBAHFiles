...
DevAbd:set(SHBAH.."Abd:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAbd:get(SHBAH.."Abd:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAbd:get(SHBAH.."Abd:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAbd:get(SHBAH.."Abd:ProNames:Num"..msg.chat_id_) or 5
...
if DevAbd:get(SHBAH.."Abd:Lock:ProNames"..msg.chat_id_) and DevAbd:get(SHBAH.."Abd:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbd:get(SHBAH.."Abd:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbd:srem(SHBAH..'Abd:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbd:get(SHBAH.."Abd:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbd:get(SHBAH.."Abd:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevAbd:sadd(SHBAH..'Abd:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevAbd:del(SHBAH.."Abd:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAbd:set(SHBAH.."Abd:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAbd:del(SHBAH.."Abd:Lock:ProNames"..msg.chat_id_)
end
end
