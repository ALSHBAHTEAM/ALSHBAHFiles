...
if DevAbd:get(SHBAH.."Abd:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbd:sadd(SHBAH.."Abd:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbd:srem(SHBAH.."Abd:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbd:del(SHBAH.."Abd:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbd:smembers(SHBAH.."Abd:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbd:get(SHBAH.."Abd:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
SHBAHName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if SHBAHName then 
SHBAHNames = DevAbd:smembers(SHBAH.."Abd:Mute:Names"..msg.chat_id_) or ""
if SHBAHNames and SHBAHNames[1] then 
for i=1,#SHBAHNames do 
if SHBAHName:match("(.*)("..SHBAHNames[i]..")(.*)") then 
...
DevAbd:set(SHBAH.."Abd:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbd:del(SHBAH.."Abd:Lock:MuteNames"..msg.chat_id_)
end
end
end
